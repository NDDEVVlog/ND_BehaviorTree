// --- MODIFIED FILE: RandomPatrolNode.cs ---
using UnityEngine;
...
namespace ND_BehaviorTree
{
    ...
    public class RandomPatrolNode : ActionNode
    {
        ...
        {
            // --- THIS IS THE FIX ---
            // When this node is exited (either by finishing, or being interrupted by a higher-priority task),
            // tell the NavMeshAgent to stop moving.
