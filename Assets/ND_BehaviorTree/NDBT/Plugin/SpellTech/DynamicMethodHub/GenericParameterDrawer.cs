...
namespace SpellTech.DynamicMethodEvent
{
    ...
    public class GenericParameterDrawer : PropertyDrawer
    {
            ...
            if (property.isExpanded)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            Debug.LogWarning($"GenericParameter at {property.propertyPath} is null. Ensure it is initialized with a concrete type.");
                            return;
                        }
        ...
        private string GetVisiblePropertyNames(SerializedProperty property)
        {
