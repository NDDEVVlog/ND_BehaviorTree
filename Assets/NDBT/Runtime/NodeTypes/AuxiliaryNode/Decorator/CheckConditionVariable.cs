// --- MODIFIED FILE: CheckConditionVariable.cs ---

using UnityEngine;

namespace ND_BehaviorTree
{   
    [NodeInfo("Check Condition Variable", "Decorator/CheckConditionVariable", true, true, iconPath:"Assets/NDBT/Icons/CheckCondition.png")]
